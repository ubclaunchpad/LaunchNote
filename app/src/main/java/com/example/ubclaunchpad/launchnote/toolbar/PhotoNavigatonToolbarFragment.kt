...
class PhotoNavigatonToolbarFragment : Fragment() {
    ...
    sealed class ToolbarMode(val elements: ArrayList<ElementInfo>) : Serializable {
        ...
        companion object {
            val editButtonsListeners = arrayOf(R.id.edit_toolbar_back_btn, R.id.edit_toolbar_delete_btn, R.id.edit_toolbar_text_view, R.id.edit_toolbar_edit_desc_btn,R.id.edit_toolbar_save_btn)
